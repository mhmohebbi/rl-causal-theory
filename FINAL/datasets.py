...
try:
    df = pd.read_csv('./CAUSAL/datasets/564_fried.csv')
    X = df.iloc[:, :-1]
    y = df.iloc[:, -1:]
except:
    print("564_fried not found, fetching from kaggle")
    df = fetch_data('564_fried')
    X = df.iloc[:, :-1]
    y = df.iloc[:, -1:]
...
try:
    df = pd.read_csv('./CAUSAL/datasets/595_fri_c0_1000_10.csv')
    X = df.iloc[:, :-1]
    y = df.iloc[:, -1:]
except:
...
try:
    df = pd.read_csv('./CAUSAL/datasets/609_fri_c0_1000_5.csv')
    X = df.iloc[:, :-1]
    y = df.iloc[:, -1:]
except:
...
try:
    df = pd.read_csv('./CAUSAL/datasets/573_cpu_act.csv')
    X = df.iloc[:, :-1]
    y = df.iloc[:, -1:]
except:
...
try:
    df = pd.read_csv('./CAUSAL/datasets/218_house_8L.csv')
    X = df.iloc[:, :-1]
    y = df.iloc[:, -1:]
except:
...
try:
    df = pd.read_csv('./CAUSAL/datasets/574_house_16H.csv')
    X = df.iloc[:, :-1]
    y = df.iloc[:, -1:]
except:
...
try:
    df = pd.read_csv('./CAUSAL/datasets/197_cpu_act.csv')
    X = df.iloc[:, :-1]
    y = df.iloc[:, -1:]
except:
...
try:
    df = pd.read_csv('./CAUSAL/datasets/227_cpu_small.csv')
    X = df.iloc[:, :-1]
    y = df.iloc[:, -1:]
except:
...
try:
    df = pd.read_csv('./CAUSAL/datasets/562_cpu_small.csv')
    X = df.iloc[:, :-1]
    y = df.iloc[:, -1:]
except:
...
try:
    df = pd.read_csv('./CAUSAL/datasets/294_satellite_image.csv')
    X = df.iloc[:, :-1]
    y = df.iloc[:, -1:]
except:
...
try:
    df = pd.read_csv('./CAUSAL/datasets/623_fri_c4_1000_10.csv')
    X = df.iloc[:, :-1]
    y = df.iloc[:, -1:]
except:
...
try:
    df = pd.read_csv('./CAUSAL/datasets/537_houses.csv')
    X = df.iloc[:, :-1]
    y = df.iloc[:, -1:]
except:
...
try:
    df = pd.read_csv('./CAUSAL/datasets/225_puma8NH.csv')
    X = df.iloc[:, :-1]
    y = df.iloc[:, -1:]
except:
...
try:
    df = pd.read_csv('./CAUSAL/datasets/Airfoil-Self-Noise.csv')
    X = df.iloc[:, :-1]
    y = df.iloc[:, -1:]
except:
...
try:
    df = pd.read_csv('./CAUSAL/datasets/ConcreteCompressiveStrength.csv')
    X = df.iloc[:, :-1]
    y = df.iloc[:, -1:]
except:
...
try:
    df = pd.read_csv('./CAUSAL/datasets/529_pollen.csv')
    X = df.iloc[:, :-1]
    y = df.iloc[:, -1:]
except:
...
try:
    df = pd.read_csv('./CAUSAL/datasets/503_wind.csv')
    X = df.iloc[:, :-1]
    y = df.iloc[:, -1:]
except:
...
try:
    df = pd.read_csv('./CAUSAL/datasets/WineQuality.csv')
    X = df.iloc[:, :-1]
    y = df.iloc[:, -1:]
except:
...
class ParkinsonsTelemonitoringDataset(AbstractDataset):
    def __init__(self):
        try:
            df = pd.read_csv('./CAUSAL/datasets/ParkinsonsTelemonitoring.csv')
            X = df.iloc[:, :-1]
            y = df.iloc[:, -1:]
        except:
...
class AuctionVerificationDataset(AbstractDataset):
    def __init__(self):
        try:
            df = pd.read_csv('./CAUSAL/datasets/AuctionVerification.csv')
            X = df.iloc[:, :-1]
            y = df.iloc[:, -1:]
        except:
